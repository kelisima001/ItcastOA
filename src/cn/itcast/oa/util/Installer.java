...
*/
		// ===================================================
		// 二、权限数据
		Privilege menu, menu1, menu2, menu3, menu4, menu5, menu6, menu7,menu8;
		...
		/*menu6 = new Privilege("网上交流", null, "FUNC20064.gif", null);
		menu7 = new Privilege("论坛管理", "forumManageAction_list", null, menu6);
		menu8 = new Privilege("论坛", "forumAction_list", null, menu6);
