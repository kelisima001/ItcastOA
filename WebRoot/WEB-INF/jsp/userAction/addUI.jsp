                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td><%-- <select name="departmentId" class="SelectStyle">
                            ...
                            cssClass="SelectStyle" name="departmentId"
					...
					<tr><td>性别</td>
                        <td><s:radio name="gender" list="%{ {'男','女'} }" id=""></s:radio>
						</td>
                    </tr>
					<tr><td>联系电话</td>
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><%-- <select name="roleIdList" multiple="true" size="10" class="SelectStyle">
                            ...
                            <s:select list="#roleList" name="roleIdList" listKey="" listValue=""
                            headerKey="" headerValue="" cssClass="SelectStyle"></s:select>
                            按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
                </table>
